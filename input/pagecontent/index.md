...
Note that many of these expand the existing scope of the SoA project and will work best in a collaboration with other research-aware IGs such as the [Vulcan Retrieval of Real World Data for Clinical Research IG](http://hl7.org/fhir/uv/vulcan-rwd/2023Jan/) and [Vulcan Utilising the Digital Protocol](https://build.fhir.org/ig/HL7/vulcan-udp-ig/en/).  We have a rigorous process for evaluating and incorporating use cases into the development process.
...
[^3]: [CLINICAL ELECTRONIC STRUCTURED HARMONISED PROTOCOL - M11](https://database.ich.org/sites/default/files/ICH_Step4_M11_Final_Guideline_2025_1119.pdf)
